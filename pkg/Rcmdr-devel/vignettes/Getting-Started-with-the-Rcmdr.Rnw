...
\bibliographystyle{apalike2} % For bibliography style
\usepackage{amsmath}%
...
\author{John Fox}
\date{Version 2.6-0 (last modified: 2019-08-15)}
\maketitle
...
\textbf{R } statistical computing environment \citep{RCore19}. This manual is a brief,
