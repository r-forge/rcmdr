...
Options <- function(){
	...
	console.messages <- setOption("console.messages", FALSE)   ##rmh
	iconify.commander <- setOption("iconify.commander", FALSE) ##rmh
	...
	consoleMessagesVar <- tclVar(console.messages)                                ##rmh
	consoleMessagesCheckBox <- tkcheckbutton(top, variable=consoleMessagesVar)    ##rmh
	iconifyCommanderVar <- tclVar(iconify.commander)                              ##rmh
	iconifyCommanderCheckBox <- tkcheckbutton(top, variable=iconifyCommanderVar)  ##rmh
	...
	onOK <- function(){
		...
		console.messages <- as.logical(tclvalue(consoleMessagesVar) == "1")   ##rmh
		iconify.commander <- as.logical(tclvalue(iconifyCommanderVar) == "1") ##rmh
		...
		options$console.messages <- console.messages   ##rmh
		options$iconify.commander <- iconify.commander ##rmh
	...
	tkgrid(labelRcmdr(top, text=gettextRcmdr("Send messages to R Console")), consoleMessagesCheckBox, sticky="e")  ##rmh
	tkgrid.configure(consoleMessagesCheckBox, sticky="w")                                                          ##rmh
	tkgrid(labelRcmdr(top, text=gettextRcmdr("Iconify Commander Window")), iconifyCommanderCheckBox, sticky="e")       ##rmh
	tkgrid.configure(iconifyCommanderCheckBox, sticky="w")                                                         ##rmh
